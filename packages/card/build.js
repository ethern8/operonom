...
const data = {
  ...
  github: chalk.gray('https://github.com/') + chalk.green('ethern8'),
  linkedin: chalk.gray('https://linkedin.com/in/') + chalk.blue('nathansweany'),
  //web: chalk.cyan('https://bnb.im'),
  npx: chalk.red('npx') + ' ' + chalk.white('@ethern8/card  (via GitHub Package Registry)'),
